  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe>
        ...
        <el-table-column prop="labName" label="机房" show-overflow-tooltip></el-table-column>
        <el-table-column prop="labadminName" label="机房管理员" show-overflow-tooltip></el-table-column>
