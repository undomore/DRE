<template>
  <div>
    <div class="search">
      <el-select v-model="typeId" placeholder="请选择分类" style="width: 200px">
        <el-option v-for="item in typeData" :label="item.name" :value="item.id"></el-option>
      </el-select>
      <el-input placeholder="请输入设备编号" style="width: 200px; margin-left: 5px" v-model="name"></el-input>
