<template>
  <div>
    <div class="search">
      <el-input clearable placeholder="请输入机位设备编号" style="width: 200px" v-model="name"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="name" label="机位名称" show-overflow-tooltip width="150"></el-table-column>
        <el-table-column prop="descr" label="描述" show-overflow-tooltip ></el-table-column>
        <el-table-column prop="start" label="开机时间" show-overflow-tooltip></el-table-column>
        <el-table-column prop="end" label="关机时间" show-overflow-tooltip></el-table-column>
        <el-table-column prop="status" label="状态" show-overflow-tooltip></el-table-column>
        <el-table-column prop="typeName" label="所属分类" show-overflow-tooltip width="150"></el-table-column>
        <el-table-column prop="labadminName" label="机房管理员"></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        <el-form-item prop="name" label="机位名称">
        ...
        <el-form-item prop="typeId" label="机位设备分类" label-width="120px">
